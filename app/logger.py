...
class Logger:
    def __init__(self, set_level="INFO",
        ...
        # handler_list.append(
        #     TimedRotatingFileHandler(os.path.join(log_path, log_name), when='midnight', interval=1, backupCount=2,
        #                              encoding='utf-8'))
        handler_list.append(RotatingFileHandler(os.path.join(log_path, log_name), maxBytes=1024 * 1024, backupCount=40))
